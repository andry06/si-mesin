...
<div class="col-md-7">
                    ...
                    @forelse($merkmesin as $key => $mm)
                        <tr>
                            ...
                            <td style="width:10px; padding-top:6px; padding-bottom: 0px;" >
                              ...
                              <form style="display: inline-block" action="/jenismesin/{{ $mm->id }}" method="POST">
                                @csrf
                                @method('DELETE')
    ...
    <!-- /.card-start -->
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Tambah Data Merk Mesin</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form"  action="/merkmesin" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label for="merk_mesin">Merk Mesin</label>
                    <input name="merk_mesin" class="form-control" id="merk_mesin" value=" {{ old('merk_mesin', '')}}"  placeholder="Masukkan Merk Mesin">
                </div>
                @error('merk_mesin')
                ...
                <div class="form-group">
                    ...
                    <input name="singkatan" class="form-control" id="singkatan" value=" {{ old('singkatan', '')}}"  placeholder="Tentukan Singkatan">
                </div>
                @error('singkatan')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
