            ...
            <div class="card card-info">
              ...
              <br>
                ...
                <label for="filterjenismesin_id">Jenis Mesin</label>
                  ...
                  <select id="filterjenismesin_id" class="filter form-control select2bs4 @error('jenismesin_id') is-invalid @enderror" >
                  ...
                  <tr>
                    ...
                    <td>
                      <form method="post" id="form-excel">
                        @csrf
                        <input type="hidden" name="filterjenismesin_id" id="hasiljenismesin_id">
...
<script>
  ...
  $(".filter").on('change', function(){
     ...
     $("#hasiljenismesin_id").val(filter_jenismesin);
