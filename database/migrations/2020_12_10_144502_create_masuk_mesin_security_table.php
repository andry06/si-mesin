...
class CreateMasukMesinSecurityTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('masuk_mesin_security', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('masuk_mesin_security');
    }
}
